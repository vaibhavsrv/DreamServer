...
class TestNumericSafeFactorialSafe:
    def test_valid_factorial(self):
        from helpers import numeric_safe_factorial_safe
        assert numeric_safe_factorial_safe(5) == 120
        assert numeric_safe_factorial_safe(0) == 1

    def test_invalid_inputs(self):
        from helpers import numeric_safe_factorial_safe
        assert numeric_safe_factorial_safe(-3) == 0
        assert numeric_safe_factorial_safe(100) == 0
