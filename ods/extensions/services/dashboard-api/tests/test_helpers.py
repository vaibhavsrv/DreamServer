...
class TestNumericSafeVarianceSafe:
    def test_valid_variance(self):
        from helpers import numeric_safe_variance_safe
        assert numeric_safe_variance_safe([2, 4, 4, 4, 5, 5, 7, 9]) == 4.0

    def test_invalid_inputs(self):
        from helpers import numeric_safe_variance_safe
        assert numeric_safe_variance_safe(None) == 0.0
        assert numeric_safe_variance_safe(["a", "b"]) == 0.0
