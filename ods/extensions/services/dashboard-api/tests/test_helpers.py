...
class TestStringCapitalizeWordsSafe:
    def test_valid_capitalization(self):
        from helpers import string_capitalize_words_safe
        assert string_capitalize_words_safe("hello world test") == "Hello World Test"

    def test_invalid_inputs(self):
        from helpers import string_capitalize_words_safe
        assert string_capitalize_words_safe(None) == ""
        assert string_capitalize_words_safe(777) == ""
