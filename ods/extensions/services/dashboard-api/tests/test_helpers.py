...
class TestNumericGeometricMeanSafe:
    def test_valid_geometric_mean(self):
        from helpers import numeric_geometric_mean_safe
        assert numeric_geometric_mean_safe([2, 8]) == 4.0

    def test_invalid_inputs(self):
        from helpers import numeric_geometric_mean_safe
        assert numeric_geometric_mean_safe(None) == 0.0
        assert numeric_geometric_mean_safe([-1, 0, "a"]) == 0.0
