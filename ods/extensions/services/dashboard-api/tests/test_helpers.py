...
class TestListZipLongestPaddedSafe:
    def test_valid_zipping(self):
        from helpers import list_zip_longest_padded_safe
        assert list_zip_longest_padded_safe([1, 2], ["a"], fillvalue="-") == [(1, "a"), (2, "-")]

    def test_invalid_inputs(self):
        from helpers import list_zip_longest_padded_safe
        assert list_zip_longest_padded_safe(None, [1]) == [(None, 1)]
        assert list_zip_longest_padded_safe(None, None) == []
